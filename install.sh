...
# Step 4: Insert database credentials into application2.properties
echo "Updating application.properties with database credentials..."

# Check if application2.properties exists
if [ -f "$APP_PROPERTIES" ]; then
    # Write database properties into the application2.properties file
